...
namespace Hoatuoi.Controllers
{
    public class UserController : Controller
    {
        ...
        public ActionResult ConfirmEmail(int ID)
        {
            ...
            SentMail("Mã xác minh tài khoản", user.Email, "hoahuongduong05124@gmail.com", "ytotxwzbrwkoddjd", "Xác minh nhanh bằng cách click vào link: " + urlBase + "User/ConfirmEmailLink/" + ID + "?Captcha=" + user.Captcha + "</p>");
            return View();
        }
        [HttpGet]
